...
public class PostRepository implements IPostRepository {
    ...
    @Override
    public Single<Map<Post, List<Topic>>> insertPost(Post post, List<Topic> topics) {
    ...
    @Override
    public Single<List<Post>> getAllPosts(Pageable pageable) {
    ...
    @Override
    public Single<Post> updateTypeById(int id, String type) {
        return rxSchedulerIo(()->{
...
//        return l.get(0);
    ...
    @Override
    public Single<Integer> getViewById(int id) {
        return rxSchedulerIo(() ->dslContext.select(Tables.POST.VIEW_POST)
                .from(Tables.POST)
                .where(Tables.POST.ID.eq(id))
                .execute()) ;
    ...
    @Override
    public Single<Post> updateContentById(int id, String content) {
...
//        return l.get(0);
    ...
    @Override
    public Single<Post> updateTitleById(int id, String title) {
        return rxSchedulerIo(()->{
            List<Post> l = new ArrayList<Post>();
            dslContext.transaction(out -> {
                DSLContext context = DSL.using(out);
...
//        return l.get(0);
    ...
    @Override
    public Single<Post> updateViewById(int id) {
        return rxSchedulerIo(()->{
            List<Post> l = new ArrayList<Post>();
            dslContext.transaction(out -> {
                DSLContext context = DSL.using(out);
